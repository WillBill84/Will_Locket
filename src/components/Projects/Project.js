...
class Projects extends Component {
    ...
    render() {
        return (
            ...
            <Project imgsrc={JSG} imgalt={"Jenny Smith Gardens"} title={"Jenny Smith Gardens"} description={"I did the UX/UI designs and was involved with the development of this custom website while working at Left Brain Solutions."} link={"http://www.jsg.net.au/"} />
